...
CUDA_VISIBLE_DEVICES=0 nohup python -u tools/train.py configs/custom/moe/pix2pix/pix2pix_moe_trad.py
CUDA_VISIBLE_DEVICES=0 nohup python -u tools/train.py configs/custom/moe/pix2pix/pix2pix_moe_dl.py
