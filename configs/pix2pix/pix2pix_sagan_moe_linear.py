_base_ = [
    '../_base_/models/pix2pix/pix2pix_sagan.py',
...
dataroot = 'data/paired/moe_linear_128'
data = dict(
...
'''
optimizer = dict(
    generators=dict(type='Adam', lr=0.0001, betas=(0.0, 0.999)),
    discriminators=dict(type='Adam', lr=0.0004, betas=(0.0, 0.999)))
...
total_iters = 190000
workflow = [('train', 1)]
exp_name = 'pix2pix_sagan_moe_linear'
work_dir = f'./work_dirs/experiments/{exp_name}'
num_images = 20
metrics = dict(
    FID=dict(type='FID', num_images=num_images, image_shape=(3, 128, 128)),
    IS=dict(
        type='IS',
